...
| [Gray]{.key .key-gray} | **Team** | What applies only to my team? (for example, your team's file names) Click to open. |
| [Gray]{.key .key-gray} | | Also used for answers and checklists. Click to open. |

**Read every [red]{.key .key-red} box. Follow [green]{.key .key-green}. Slow down at [yellow]{.key .key-yellow}. Open [blue]{.key .key-blue} only when you want more. Open the [gray]{.key .key-gray} box with your team's name.**
