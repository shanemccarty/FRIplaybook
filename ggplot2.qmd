...
[![the grammar of graphics has 7 layers (\[ggplot2.tidyverse.org\](https://ggplot2.tidyverse.org/articles/ggplot2.html))](images/ggplot2-layers.png){fig-alt="the image includes 7 colors for each of the 7 layers"}](https://ggplot2.tidyverse.org/articles/ggplot2.html)
