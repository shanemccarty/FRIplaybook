---
title: "How Code Builds a Plot"
subtitle: "Watch a plot grow one layer at a time, right in your browser"
author:
  - Andrew Silhavy
  - Shane McCarty, PhD
abstract: |
...
These two lines import the data and turn on the `ggplot2` package. (In the Try it boxes, this has already been done for you.)
...
Your *RD Report* and *Final Report* must include `ggsave( )` for plots, because you will want to easily export these plots and then add them onto your team poster.
:::
