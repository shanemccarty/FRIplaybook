...
[Alternative Text for Figures and Images (Fig-Alt)](#alt-text) was added and is a requirement for your Quarto report and manuscript.
:::
...
The format is different for the code chunk options using `#|` (e.g., `#| label:`) vs. using `#` to comment (e.g., `#source:`). The #source will be at the bottom of your code chunk.
:::
