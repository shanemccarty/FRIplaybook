...
- Create a new `.qmd` document for each lab, naming them: `Lastname_lab1.qmd`, `Lastname_lab2.qmd`, `Lastname_lab3.qmd`, `Lastname_lab4.qmd`, and `Lastname_lab5.qmd`
...
::: {.callout-important}
## Important: `code-fold: false` in your YAML
