---
title: "Start Quarto Markdown Document"
subtitle: "Create .qmd, Write in Markdown, Add Meta-data in YAML, and Create Code Chunks"
...
-   **Cheat Sheet**: [Quarto](https://rstudio.github.io/cheatsheets/quarto.pdf)
-   **Posit Interactive Page**: [Quarto](https://rstudio.github.io/cheatsheets/html/quarto.html)
:::
...
- create a `team_RD.qmd` file - create a `team_final.qmd` file
