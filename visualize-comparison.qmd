...
This chapter is the Visualize step on [The Analysis Map](analysis-map.qmd) for a **comparison** question: groups (a categorical variable) and one continuous score. New to `ggplot2` layers? Read [Coding a Plot](layers.qmd) first.
:::
