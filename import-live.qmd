---
title: "Import Data Live using qualtrRics"
subtitle: "How to automate data export and import"
author: "Gavin Rualo"
abstract: |
  This chapter demonstrates how to programmatically download survey data from Qualtrics
  using the Qualtrics API. Researchers learn to authenticate with Qualtrics, initiate data
...
::: {.callout-important}
## Important: Advanced module (not required)

This is an *advanced* *chapter* and not required for your report!
:::
