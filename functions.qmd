---
title: "Use Functions to Write Text"
subtitle: "How to use inline R code instead of text"
author: "Zihan Hei"
abstract: |
...
A subset of data from a March, 15, 2025 Prolific-collected sample is included below for demonstration purposes. More of the full data can be found at: [https://fripublichealth.quarto.pub/zerosum/readme-preview.html](https://fripublichealth.quarto.pub/zerosum/readme-preview.html)
...
## Example 1: Reporting Sample Size (using inline R code)

### create an object for `total_responses`
...
## Example 2: Report Numbers and Percentages (using inline R)
