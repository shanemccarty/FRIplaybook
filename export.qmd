...
-   [ ] Rename both files using the date MONTH.DAY.YEAR.filename.team#.filetype. For example, you should use `{r} current_date` in the correct format and update the file names: `{r} current_date`.data.team1.csv and {r} current_date`.data.team1.xlsx
