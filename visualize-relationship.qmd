...
This chapter is the Visualize step on [The Analysis Map](analysis-map.qmd) for a **relationship** question: two continuous scores. New to `ggplot2` layers? Read [How Code Builds a Plot](layers.qmd) first.
:::
