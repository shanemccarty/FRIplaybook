<!-- Single source for the ggplot2 resource links. Included in the Preface (color key example), Coding a Plot, Visualize a Comparison, and Visualize a Relationship. Edit it here once; every place updates. -->
