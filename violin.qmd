...
More information on `tidyr` is available in the [chapter](#tidyr.qmd)
...
There are many different ways to create a raincloud plot:
-   [Raincloud plots with ggplot2](https://z3tt.github.io/Rainclouds/)
-   [Raincloudplots](https://github.com/jorvlan/raincloudplots)
-   [geom_paired__raincloud()](https://yjunechoe.github.io/posts/2020-07-13-geom-paired-raincloud/)
:::
